...
#### 更新2022/07/12：老板娘也要求我赔偿，大概要1000多，甚至更多（因为木板可能也泡坏了）
...
#### 删BV1at41117bF-How to Learn Anything... Fast - Josh Kaufman
...
很有收获的是，彭帅积极引荐了团队内部人员，他也恰好学过高翔的slam教程。
...
> 恶性循环最终导致他们如你所见
> 你的解药有二
> 第一点是做好万夫当关的准备，永远不被嫉妒嘲笑恶语所伤，奋力向前将他们狠狠地甩在后面，这是生存的智慧
> 第二点是开怀大笑笑天下之人，不怒不争容天下之事，这是人生的终途
...
### timewarp的logic测试通过，应该说一期工作完美结束了

## 2022-02-23

### 一天持续工作，完成了opengl的timewarp集成
...
今天花了数个小时，综合各种方法，将134篇文档的所有图片引用都云端化。

这将有几个好处：

1. 原先由于是本地以相对路径存储，导致一旦文件移动（或剪切粘贴），则图片将失效，云端后将不存在该问题。
    - 这是由于插件 `markdown-image` 不支持/默认绝对路径存储，其次若以绝对路径存储，则github上将失效
2. 目前图片大小已经成为最占本项目空间的因素，云端后将大幅（预期90+%）减小项目体积，并且方便将图片存档保存到移动硬盘等地方去
...
当前体积：
![picture 4](https://mark-vue-oss.oss-cn-hangzhou.aliyuncs.com/changes-1644168079624-4633d4f07823c3b5df4c37e3efedcb0d0161bfbb6ef21a4caf1cf3412bd2a64b.png)  

清除后体积：(~~暂时还没刷新~~，由于图片虽然删除，但其实已经在commit历史中，所以仓库大小依旧以其计算，因此大小不会有什么变化)
...
连续一周几乎都没怎么睡觉，今天是8点半搞完活的，一分钟也没睡，冲了个澡就来公司了。

但没想到今天人还挺多，都没什么座位坐，所以中午就换到茶歇处趴着睡了大概半小时这个样子，实在不爽，于是还是直接干起咖啡了。

便利蜂九块钱的双袋糖加冰拿铁真地很可以，直逼四倍的星爸爸。

问了问hr姐姐和老大，都开始交换回家的意见了，考虑到项目应该确实算缓下来了，是时候功成身退了吧。

不过有意思的是，同事偷看我笔记，并fork了一下，hh。
...
终于打完patch了！我的妈，12天高度紧张的工作，三天只睡了五小时，每天日均三杯咖啡，压力大到抽起烟的我终于可以暂舒一口气了。
...
其次就是可恶的权限系统了。虽然作为外援（而非外包），我还是拿到了最基本的权利：电梯卡、人脸识别、美团订餐、公司电脑，这些最基本的他们都提供了，尤其是项目管理部的玲玲姐，很nice，很努力地帮我搞完了系统流程，尤其是人脸识别部分。但是涉及到实际项目开发的部分，才是真正地难熬。硬件方面，用惯了mac的我，鼠标和键盘我都非常不习惯，而且我还有边工作边记录的习惯，目前却没办法实现，一方面是vscode不方便同步，我也不想把我的working directory同步到理想的网上；另一方面这个键盘也是极其影响我的记录效率，我是非常非常非常非常极度不喜欢用凸起的键盘的，无论是普通键盘还是机械键盘，并且以后也不打算习惯。

所以后来在询问了一些技术同事后，发现有一种方案叫synergy，允许我用一台机器的鼠标和键盘同时操纵两台不同的电脑，我花了一两小时在研究这个，所有的配置环节包括激活码环节都搞定了，但最后还是栽在了公司的权限上。因为synergy是一种基于局域网的解决方案，而联想配的电脑是在内网，我的mac是在guest网，两个网不互通，另一方面联想的电脑开启了各个层级的防火墙，导致synergy也没法使用。这个问题，我看，从网络上应该是没法解决了，因为他们肯定不允许我的mac接入内网，也不会允许他们的机器关闭防火墙，实在要同步控制，可能要考虑昂贵的硬件方案。我也搜了一搜相关的硬件市场，但好像还没弄明白。

此外，其实，昨天最大的问题应该是办公环境太热，然后我穿的大衣又不想脱，中午没睡到午觉（趴了一会被电话喊醒去弄人脸识别了），所以整个下午身体处在非常崩溃、虚弱的边缘，头脑几度有暖流流过那种。不过尽管如此，第一天的工作还算是顺利推进的，在他们的windows电脑上使用virtualbox搭建了ubuntu的开发环境，修改了网速最快的源，配置了git，开始拉aosp。sync的时候已经是晚上8点多，因为sync至少要一个小时，所以我觉得是时候先下班了，第二天再去看。

说到这个开发环境，还是得提一下坐我对面的刘志刚同志。刚哥是一个典型的IT男，直接拖鞋单衣，好不快活。人缘很好，大家都找他，技术看的出来，应该还是很不错的，有点像趣立士帆哥的感觉，但明显感觉过的比士帆哥潇洒，他的飞书名片也很有意思，签名是：“工作稳定，xxxx”。然后长的很像我考上南大软件的舍友，哈哈哈哈，是一个好老实人。
